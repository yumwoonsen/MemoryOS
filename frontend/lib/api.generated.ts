...
export interface paths {
    ...
    "/v2/memories/interpret-varied-delivery": {
        ...
        put?: never;
        /**
         * Interpret Varied Delivery V2
         * @description Interpret telemetry within a bounded, cooldown-aware mission-family pool.
         */
        post: operations["interpret_varied_delivery_v2_v2_memories_interpret_varied_delivery_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        DeliveryMissionObjectiveV2: {
            ...
            /** Objective Id */
            objective_id: string;
            objective_role: components["schemas"]["MissionObjectiveRoleV2"];
            /** Required */
            required: boolean;
            /** Source Event Ids */
         ...
         * @description Trusted-server request for one controlled mission-variation generation.
         */
        InterpretVariedDeliveryRequestV2: {
            /**
             * Generation Nonce
            ...
            telemetry: components["schemas"]["RawTelemetryBatchV2"];
        };
        /**
         * IssueSeverity
         * @enum {string}
        ...
        MissionAffordanceV2: {
             ...
             * @description Ordered backend-owned chapter objectives: squad-entry prerequisite, one to three compatible grounded gameplay mechanics, and match completion.
             */
        ...
        MissionCapabilityCandidate: {
            ...
            candidate_id: string;
            /** Compatibility Tags */
            compatibility_tags: components["schemas"]["MissionCompatibilityTagV2"][];
            objective_role: components["schemas"]["MissionObjectiveRoleV2"];
            recipe: components["schemas"]["QuestRecipe"];
            /** Required */
            required: boolean;
         ...
         * @description Neutral mechanical tags used by the deterministic chapter composer.
         * @enum {string}
         */
        MissionCompatibilityTagV2: "squad_entry" | "location" | "individual_assignment" | "squad_coordination" | "combat" | "support_action" | "tactical" | "vehicle" | "placement" | "match_completion";
        /**
         * MissionFamilyV2
         * @enum {string}
         */
         ...
         * @description Backend-owned purpose of one player-visible chapter objective.
         * @enum {string}
         */
        MissionObjectiveRoleV2: "prerequisite" | "primary" | "support" | "bonus" | "completion";
        /**
...
export interface operations {
    ...
    interpret_varied_delivery_v2_v2_memories_interpret_varied_delivery_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["InterpretVariedDeliveryRequestV2"];
            };
        };
        responses: {
            /** @description Successful Response */
